...
import type { Organization, Church, ChurchFull } from '@/lib/types';
      ...
      <main style={{ maxWidth: "1000px", margin: "0 auto", padding: "70px 20px", textAlign: "center" }}>
        <div style={{
          ...
          <p style={{ fontSize: "15px", color: "#64748b", lineHeight: "1.6", marginBottom: "32px", maxWidth: "460px", margin: "0 auto 32px" }}>
            We are upgrading your church portal ({c?.name || org?.name || "your church"}) with advanced analytics, service schedules, and team management.
          </p>
